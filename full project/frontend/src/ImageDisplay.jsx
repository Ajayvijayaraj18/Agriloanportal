...
const ImageDisplay = () => {
  ...
  const images = [
    ...
    'https://images.pexels.com/photos/269138/pexels-photo-269138.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    'https://images.pexels.com/photos/2132051/pexels-photo-2132051.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    'https://images.pexels.com/photos/3700908/pexels-photo-3700908.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
  ];
  ...
  return (
    <div className='img'>
        <center>
      <img  style={{width:'1000px', height:'600px' , marginBottom: '0px' , marginLeft: '0px'}} src={images[currentIndex]} alt={`Image ${currentIndex + 1}`} />
      </center>
    </div>
  );
};
